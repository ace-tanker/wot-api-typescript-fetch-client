 ...
 * @export
 * @interface TanksStatsDataValueItemRandom
 */
export interface TanksStatsDataValueItemRandom {
    /**
     * Battles fought
     * @type {number}
     * @memberof TanksStatsDataValueItemRandom
     */
    battles: number;
    /**
     * Victories
...
/**
 * Check if a given object implements the TanksStatsDataValueItemRandom interface.
 */
export function instanceOfTanksStatsDataValueItemRandom(value: object): value is TanksStatsDataValueItemRandom {
...
export function TanksStatsDataValueItemRandomFromJSON(json: any): TanksStatsDataValueItemRandom {
    return TanksStatsDataValueItemRandomFromJSONTyped(json, false);
}

export function TanksStatsDataValueItemRandomFromJSONTyped(json: any, ignoreDiscriminator: boolean): TanksStatsDataValueItemRandom {
    if (json == null) {
        return json;
    }
    return {
...
export function TanksStatsDataValueItemRandomToJSON(json: any): TanksStatsDataValueItemRandom {
    return TanksStatsDataValueItemRandomToJSONTyped(json, false);
}

export function TanksStatsDataValueItemRandomToJSONTyped(value?: TanksStatsDataValueItemRandom | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
...
export const TanksStatsDataValueItemRandomPropertyValidationAttributesMap: {
    [property: string]: {
        maxLength?: number,
        minLength?: number,
        pattern?: string,
