 ...
 * @export
 * @interface TanksStatsDataValueItemGlobalmap
 */
export interface TanksStatsDataValueItemGlobalmap {
    /**
     * Battles fought
     * @type {number}
     * @memberof TanksStatsDataValueItemGlobalmap
     */
    battles: number;
    /**
     * Victories
...
/**
 * Check if a given object implements the TanksStatsDataValueItemGlobalmap interface.
 */
export function instanceOfTanksStatsDataValueItemGlobalmap(value: object): value is TanksStatsDataValueItemGlobalmap {
...
export function TanksStatsDataValueItemGlobalmapFromJSON(json: any): TanksStatsDataValueItemGlobalmap {
    return TanksStatsDataValueItemGlobalmapFromJSONTyped(json, false);
}

export function TanksStatsDataValueItemGlobalmapFromJSONTyped(json: any, ignoreDiscriminator: boolean): TanksStatsDataValueItemGlobalmap {
    if (json == null) {
        return json;
    }
    return {
...
export function TanksStatsDataValueItemGlobalmapToJSON(json: any): TanksStatsDataValueItemGlobalmap {
    return TanksStatsDataValueItemGlobalmapToJSONTyped(json, false);
}

export function TanksStatsDataValueItemGlobalmapToJSONTyped(value?: TanksStatsDataValueItemGlobalmap | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
...
export const TanksStatsDataValueItemGlobalmapPropertyValidationAttributesMap: {
    [property: string]: {
        maxLength?: number,
        minLength?: number,
        pattern?: string,
