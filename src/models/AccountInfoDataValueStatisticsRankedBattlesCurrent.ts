 ...
 * @export
 * @interface AccountInfoDataValueStatisticsRankedBattlesCurrent
 */
export interface AccountInfoDataValueStatisticsRankedBattlesCurrent {
    /**
     * Battles fought
     * @type {number}
     * @memberof AccountInfoDataValueStatisticsRankedBattlesCurrent
     */
    battles: number;
    /**
     * Victories
...
/**
 * Check if a given object implements the AccountInfoDataValueStatisticsRankedBattlesCurrent interface.
 */
export function instanceOfAccountInfoDataValueStatisticsRankedBattlesCurrent(value: object): value is AccountInfoDataValueStatisticsRankedBattlesCurrent {
...
export function AccountInfoDataValueStatisticsRankedBattlesCurrentFromJSON(json: any): AccountInfoDataValueStatisticsRankedBattlesCurrent {
    return AccountInfoDataValueStatisticsRankedBattlesCurrentFromJSONTyped(json, false);
}

export function AccountInfoDataValueStatisticsRankedBattlesCurrentFromJSONTyped(json: any, ignoreDiscriminator: boolean): AccountInfoDataValueStatisticsRankedBattlesCurrent {
    if (json == null) {
        return json;
    }
    return {
...
export function AccountInfoDataValueStatisticsRankedBattlesCurrentToJSON(json: any): AccountInfoDataValueStatisticsRankedBattlesCurrent {
    return AccountInfoDataValueStatisticsRankedBattlesCurrentToJSONTyped(json, false);
}

export function AccountInfoDataValueStatisticsRankedBattlesCurrentToJSONTyped(value?: AccountInfoDataValueStatisticsRankedBattlesCurrent | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
...
export const AccountInfoDataValueStatisticsRankedBattlesCurrentPropertyValidationAttributesMap: {
    [property: string]: {
        maxLength?: number,
        minLength?: number,
        pattern?: string,
