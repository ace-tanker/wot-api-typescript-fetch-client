 ...
 * @export
 * @interface AccountInfoValueStatisticsRanked10x10
 */
export interface AccountInfoValueStatisticsRanked10x10 {
    /**
     * Battles fought
     * @type {number}
     * @memberof AccountInfoValueStatisticsRanked10x10
     */
    battles: number;
    /**
     * Victories
...
/**
 * Check if a given object implements the AccountInfoValueStatisticsRanked10x10 interface.
 */
export function instanceOfAccountInfoValueStatisticsRanked10x10(value: object): value is AccountInfoValueStatisticsRanked10x10 {
...
export function AccountInfoValueStatisticsRanked10x10FromJSON(json: any): AccountInfoValueStatisticsRanked10x10 {
    return AccountInfoValueStatisticsRanked10x10FromJSONTyped(json, false);
}

export function AccountInfoValueStatisticsRanked10x10FromJSONTyped(json: any, ignoreDiscriminator: boolean): AccountInfoValueStatisticsRanked10x10 {
    if (json == null) {
        return json;
    }
    return {
...
export function AccountInfoValueStatisticsRanked10x10ToJSON(json: any): AccountInfoValueStatisticsRanked10x10 {
    return AccountInfoValueStatisticsRanked10x10ToJSONTyped(json, false);
}

export function AccountInfoValueStatisticsRanked10x10ToJSONTyped(value?: AccountInfoValueStatisticsRanked10x10 | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
