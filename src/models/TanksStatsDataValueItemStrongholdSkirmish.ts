 ...
 * @export
 * @interface TanksStatsDataValueItemStrongholdSkirmish
 */
export interface TanksStatsDataValueItemStrongholdSkirmish {
    /**
     * Battles fought
     * @type {number}
     * @memberof TanksStatsDataValueItemStrongholdSkirmish
     */
    battles: number;
    /**
     * Victories
...
/**
 * Check if a given object implements the TanksStatsDataValueItemStrongholdSkirmish interface.
 */
export function instanceOfTanksStatsDataValueItemStrongholdSkirmish(value: object): value is TanksStatsDataValueItemStrongholdSkirmish {
...
export function TanksStatsDataValueItemStrongholdSkirmishFromJSON(json: any): TanksStatsDataValueItemStrongholdSkirmish {
    return TanksStatsDataValueItemStrongholdSkirmishFromJSONTyped(json, false);
}

export function TanksStatsDataValueItemStrongholdSkirmishFromJSONTyped(json: any, ignoreDiscriminator: boolean): TanksStatsDataValueItemStrongholdSkirmish {
    if (json == null) {
        return json;
    }
    return {
...
export function TanksStatsDataValueItemStrongholdSkirmishToJSON(json: any): TanksStatsDataValueItemStrongholdSkirmish {
    return TanksStatsDataValueItemStrongholdSkirmishToJSONTyped(json, false);
}

export function TanksStatsDataValueItemStrongholdSkirmishToJSONTyped(value?: TanksStatsDataValueItemStrongholdSkirmish | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
...
export const TanksStatsDataValueItemStrongholdSkirmishPropertyValidationAttributesMap: {
    [property: string]: {
        maxLength?: number,
        minLength?: number,
        pattern?: string,
