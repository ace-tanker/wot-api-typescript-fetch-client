 ...
 * 
 * @export
 * @interface GlobalmapEventratingneighborsItem
 */
export interface GlobalmapEventratingneighborsItem {
    /**
     * Clan ID
     * @type {number}
     * @memberof GlobalmapEventratingneighborsItem
     */
    clanId: number;
    /**
     * Clan name
...
/**
 * Check if a given object implements the GlobalmapEventratingneighborsItem interface.
 */
export function instanceOfGlobalmapEventratingneighborsItem(value: object): value is GlobalmapEventratingneighborsItem {
...
export function GlobalmapEventratingneighborsItemFromJSON(json: any): GlobalmapEventratingneighborsItem {
    return GlobalmapEventratingneighborsItemFromJSONTyped(json, false);
}

export function GlobalmapEventratingneighborsItemFromJSONTyped(json: any, ignoreDiscriminator: boolean): GlobalmapEventratingneighborsItem {
    if (json == null) {
        return json;
    }
    return {
...
export function GlobalmapEventratingneighborsItemToJSON(json: any): GlobalmapEventratingneighborsItem {
    return GlobalmapEventratingneighborsItemToJSONTyped(json, false);
}

export function GlobalmapEventratingneighborsItemToJSONTyped(value?: GlobalmapEventratingneighborsItem | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
