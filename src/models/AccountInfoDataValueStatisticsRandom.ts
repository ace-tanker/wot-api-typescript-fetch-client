 ...
 * @export
 * @interface AccountInfoDataValueStatisticsRandom
 */
export interface AccountInfoDataValueStatisticsRandom {
    /**
     * Battles fought
     * @type {number}
     * @memberof AccountInfoDataValueStatisticsRandom
     */
    battles: number;
    /**
     * Victories
...
/**
 * Check if a given object implements the AccountInfoDataValueStatisticsRandom interface.
 */
export function instanceOfAccountInfoDataValueStatisticsRandom(value: object): value is AccountInfoDataValueStatisticsRandom {
...
export function AccountInfoDataValueStatisticsRandomFromJSON(json: any): AccountInfoDataValueStatisticsRandom {
    return AccountInfoDataValueStatisticsRandomFromJSONTyped(json, false);
}

export function AccountInfoDataValueStatisticsRandomFromJSONTyped(json: any, ignoreDiscriminator: boolean): AccountInfoDataValueStatisticsRandom {
    if (json == null) {
        return json;
    }
    return {
...
export function AccountInfoDataValueStatisticsRandomToJSON(json: any): AccountInfoDataValueStatisticsRandom {
    return AccountInfoDataValueStatisticsRandomToJSONTyped(json, false);
}

export function AccountInfoDataValueStatisticsRandomToJSONTyped(value?: AccountInfoDataValueStatisticsRandom | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
...
export const AccountInfoDataValueStatisticsRandomPropertyValidationAttributesMap: {
    [property: string]: {
        maxLength?: number,
        minLength?: number,
        pattern?: string,
