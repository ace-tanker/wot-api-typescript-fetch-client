 ...
 * @export
 * @interface AccountInfoValueStatisticsClan
 */
export interface AccountInfoValueStatisticsClan {
    /**
     * Battles fought
     * @type {number}
     * @memberof AccountInfoValueStatisticsClan
     */
    battles: number;
    /**
     * Victories
...
/**
 * Check if a given object implements the AccountInfoValueStatisticsClan interface.
 */
export function instanceOfAccountInfoValueStatisticsClan(value: object): value is AccountInfoValueStatisticsClan {
...
export function AccountInfoValueStatisticsClanFromJSON(json: any): AccountInfoValueStatisticsClan {
    return AccountInfoValueStatisticsClanFromJSONTyped(json, false);
}

export function AccountInfoValueStatisticsClanFromJSONTyped(json: any, ignoreDiscriminator: boolean): AccountInfoValueStatisticsClan {
    if (json == null) {
        return json;
    }
    return {
...
export function AccountInfoValueStatisticsClanToJSON(json: any): AccountInfoValueStatisticsClan {
    return AccountInfoValueStatisticsClanToJSONTyped(json, false);
}

export function AccountInfoValueStatisticsClanToJSONTyped(value?: AccountInfoValueStatisticsClan | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
