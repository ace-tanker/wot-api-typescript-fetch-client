 ...
 * @export
 * @interface AccountInfoValueStatisticsGlobalmapChampion
 */
export interface AccountInfoValueStatisticsGlobalmapChampion {
    /**
     * Battles fought
     * @type {number}
     * @memberof AccountInfoValueStatisticsGlobalmapChampion
     */
    battles: number;
    /**
     * Victories
...
/**
 * Check if a given object implements the AccountInfoValueStatisticsGlobalmapChampion interface.
 */
export function instanceOfAccountInfoValueStatisticsGlobalmapChampion(value: object): value is AccountInfoValueStatisticsGlobalmapChampion {
...
export function AccountInfoValueStatisticsGlobalmapChampionFromJSON(json: any): AccountInfoValueStatisticsGlobalmapChampion {
    return AccountInfoValueStatisticsGlobalmapChampionFromJSONTyped(json, false);
}

export function AccountInfoValueStatisticsGlobalmapChampionFromJSONTyped(json: any, ignoreDiscriminator: boolean): AccountInfoValueStatisticsGlobalmapChampion {
    if (json == null) {
        return json;
    }
    return {
...
export function AccountInfoValueStatisticsGlobalmapChampionToJSON(json: any): AccountInfoValueStatisticsGlobalmapChampion {
    return AccountInfoValueStatisticsGlobalmapChampionToJSONTyped(json, false);
}

export function AccountInfoValueStatisticsGlobalmapChampionToJSONTyped(value?: AccountInfoValueStatisticsGlobalmapChampion | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
