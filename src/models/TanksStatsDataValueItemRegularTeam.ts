 ...
 * @export
 * @interface TanksStatsDataValueItemRegularTeam
 */
export interface TanksStatsDataValueItemRegularTeam {
    /**
     * Battles fought
     * @type {number}
     * @memberof TanksStatsDataValueItemRegularTeam
     */
    battles: number;
    /**
     * Victories
...
/**
 * Check if a given object implements the TanksStatsDataValueItemRegularTeam interface.
 */
export function instanceOfTanksStatsDataValueItemRegularTeam(value: object): value is TanksStatsDataValueItemRegularTeam {
...
export function TanksStatsDataValueItemRegularTeamFromJSON(json: any): TanksStatsDataValueItemRegularTeam {
    return TanksStatsDataValueItemRegularTeamFromJSONTyped(json, false);
}

export function TanksStatsDataValueItemRegularTeamFromJSONTyped(json: any, ignoreDiscriminator: boolean): TanksStatsDataValueItemRegularTeam {
    if (json == null) {
        return json;
    }
    return {
...
export function TanksStatsDataValueItemRegularTeamToJSON(json: any): TanksStatsDataValueItemRegularTeam {
    return TanksStatsDataValueItemRegularTeamToJSONTyped(json, false);
}

export function TanksStatsDataValueItemRegularTeamToJSONTyped(value?: TanksStatsDataValueItemRegularTeam | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
...
export const TanksStatsDataValueItemRegularTeamPropertyValidationAttributesMap: {
    [property: string]: {
        maxLength?: number,
        minLength?: number,
        pattern?: string,
