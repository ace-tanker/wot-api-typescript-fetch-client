 ...
 * @export
 * @interface AccountInfoDataValueStatisticsRankedBattlesPrevious
 */
export interface AccountInfoDataValueStatisticsRankedBattlesPrevious {
    /**
     * Battles fought
     * @type {number}
     * @memberof AccountInfoDataValueStatisticsRankedBattlesPrevious
     */
    battles: number;
    /**
     * Victories
...
/**
 * Check if a given object implements the AccountInfoDataValueStatisticsRankedBattlesPrevious interface.
 */
export function instanceOfAccountInfoDataValueStatisticsRankedBattlesPrevious(value: object): value is AccountInfoDataValueStatisticsRankedBattlesPrevious {
...
export function AccountInfoDataValueStatisticsRankedBattlesPreviousFromJSON(json: any): AccountInfoDataValueStatisticsRankedBattlesPrevious {
    return AccountInfoDataValueStatisticsRankedBattlesPreviousFromJSONTyped(json, false);
}

export function AccountInfoDataValueStatisticsRankedBattlesPreviousFromJSONTyped(json: any, ignoreDiscriminator: boolean): AccountInfoDataValueStatisticsRankedBattlesPrevious {
    if (json == null) {
        return json;
    }
    return {
...
export function AccountInfoDataValueStatisticsRankedBattlesPreviousToJSON(json: any): AccountInfoDataValueStatisticsRankedBattlesPrevious {
    return AccountInfoDataValueStatisticsRankedBattlesPreviousToJSONTyped(json, false);
}

export function AccountInfoDataValueStatisticsRankedBattlesPreviousToJSONTyped(value?: AccountInfoDataValueStatisticsRankedBattlesPrevious | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
...
export const AccountInfoDataValueStatisticsRankedBattlesPreviousPropertyValidationAttributesMap: {
    [property: string]: {
        maxLength?: number,
        minLength?: number,
        pattern?: string,
