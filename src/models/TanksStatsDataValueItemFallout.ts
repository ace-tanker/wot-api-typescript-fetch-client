 ...
 * Fallout statistics.
 * @export
 * @interface TanksStatsDataValueItemFallout
 */
export interface TanksStatsDataValueItemFallout {
    /**
     * Battles fought
     * @type {number}
     * @memberof TanksStatsDataValueItemFallout
     */
    battles: number;
    /**
     * Victories
...
/**
 * Check if a given object implements the TanksStatsDataValueItemFallout interface.
 */
export function instanceOfTanksStatsDataValueItemFallout(value: object): value is TanksStatsDataValueItemFallout {
...
export function TanksStatsDataValueItemFalloutFromJSON(json: any): TanksStatsDataValueItemFallout {
    return TanksStatsDataValueItemFalloutFromJSONTyped(json, false);
}

export function TanksStatsDataValueItemFalloutFromJSONTyped(json: any, ignoreDiscriminator: boolean): TanksStatsDataValueItemFallout {
    if (json == null) {
        return json;
    }
    return {
...
export function TanksStatsDataValueItemFalloutToJSON(json: any): TanksStatsDataValueItemFallout {
    return TanksStatsDataValueItemFalloutToJSONTyped(json, false);
}

export function TanksStatsDataValueItemFalloutToJSONTyped(value?: TanksStatsDataValueItemFallout | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
...
export const TanksStatsDataValueItemFalloutPropertyValidationAttributesMap: {
    [property: string]: {
        maxLength?: number,
        minLength?: number,
        pattern?: string,
