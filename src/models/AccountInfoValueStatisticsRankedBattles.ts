 ...
 * @export
 * @interface AccountInfoValueStatisticsRankedBattles
 */
export interface AccountInfoValueStatisticsRankedBattles {
    /**
     * Battles fought
     * @type {number}
     * @memberof AccountInfoValueStatisticsRankedBattles
     */
    battles: number;
    /**
     * Victories
...
/**
 * Check if a given object implements the AccountInfoValueStatisticsRankedBattles interface.
 */
export function instanceOfAccountInfoValueStatisticsRankedBattles(value: object): value is AccountInfoValueStatisticsRankedBattles {
...
export function AccountInfoValueStatisticsRankedBattlesFromJSON(json: any): AccountInfoValueStatisticsRankedBattles {
    return AccountInfoValueStatisticsRankedBattlesFromJSONTyped(json, false);
}

export function AccountInfoValueStatisticsRankedBattlesFromJSONTyped(json: any, ignoreDiscriminator: boolean): AccountInfoValueStatisticsRankedBattles {
    if (json == null) {
        return json;
    }
    return {
...
export function AccountInfoValueStatisticsRankedBattlesToJSON(json: any): AccountInfoValueStatisticsRankedBattles {
    return AccountInfoValueStatisticsRankedBattlesToJSONTyped(json, false);
}

export function AccountInfoValueStatisticsRankedBattlesToJSONTyped(value?: AccountInfoValueStatisticsRankedBattles | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
