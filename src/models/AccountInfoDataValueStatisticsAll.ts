 ...
 * @export
 * @interface AccountInfoDataValueStatisticsAll
 */
export interface AccountInfoDataValueStatisticsAll {
    /**
     * Battles fought
     * @type {number}
     * @memberof AccountInfoDataValueStatisticsAll
     */
    battles: number;
    /**
     * Victories
...
/**
 * Check if a given object implements the AccountInfoDataValueStatisticsAll interface.
 */
export function instanceOfAccountInfoDataValueStatisticsAll(value: object): value is AccountInfoDataValueStatisticsAll {
...
export function AccountInfoDataValueStatisticsAllFromJSON(json: any): AccountInfoDataValueStatisticsAll {
    return AccountInfoDataValueStatisticsAllFromJSONTyped(json, false);
}

export function AccountInfoDataValueStatisticsAllFromJSONTyped(json: any, ignoreDiscriminator: boolean): AccountInfoDataValueStatisticsAll {
    if (json == null) {
        return json;
    }
    return {
...
export function AccountInfoDataValueStatisticsAllToJSON(json: any): AccountInfoDataValueStatisticsAll {
    return AccountInfoDataValueStatisticsAllToJSONTyped(json, false);
}

export function AccountInfoDataValueStatisticsAllToJSONTyped(value?: AccountInfoDataValueStatisticsAll | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
...
export const AccountInfoDataValueStatisticsAllPropertyValidationAttributesMap: {
    [property: string]: {
        maxLength?: number,
        minLength?: number,
        pattern?: string,
