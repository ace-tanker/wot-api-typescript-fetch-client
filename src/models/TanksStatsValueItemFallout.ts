 ...
 * Fallout statistics.
 * @export
 * @interface TanksStatsValueItemFallout
 */
export interface TanksStatsValueItemFallout {
    /**
     * Battles fought
     * @type {number}
     * @memberof TanksStatsValueItemFallout
     */
    battles: number;
    /**
     * Victories
...
/**
 * Check if a given object implements the TanksStatsValueItemFallout interface.
 */
export function instanceOfTanksStatsValueItemFallout(value: object): value is TanksStatsValueItemFallout {
...
export function TanksStatsValueItemFalloutFromJSON(json: any): TanksStatsValueItemFallout {
    return TanksStatsValueItemFalloutFromJSONTyped(json, false);
}

export function TanksStatsValueItemFalloutFromJSONTyped(json: any, ignoreDiscriminator: boolean): TanksStatsValueItemFallout {
    if (json == null) {
        return json;
    }
    return {
...
export function TanksStatsValueItemFalloutToJSON(json: any): TanksStatsValueItemFallout {
    return TanksStatsValueItemFalloutToJSONTyped(json, false);
}

export function TanksStatsValueItemFalloutToJSONTyped(value?: TanksStatsValueItemFallout | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
