 ...
 * @export
 * @interface AccountInfoValueStatisticsRandom
 */
export interface AccountInfoValueStatisticsRandom {
    /**
     * Battles fought
     * @type {number}
     * @memberof AccountInfoValueStatisticsRandom
     */
    battles: number;
    /**
     * Victories
...
/**
 * Check if a given object implements the AccountInfoValueStatisticsRandom interface.
 */
export function instanceOfAccountInfoValueStatisticsRandom(value: object): value is AccountInfoValueStatisticsRandom {
...
export function AccountInfoValueStatisticsRandomFromJSON(json: any): AccountInfoValueStatisticsRandom {
    return AccountInfoValueStatisticsRandomFromJSONTyped(json, false);
}

export function AccountInfoValueStatisticsRandomFromJSONTyped(json: any, ignoreDiscriminator: boolean): AccountInfoValueStatisticsRandom {
    if (json == null) {
        return json;
    }
    return {
...
export function AccountInfoValueStatisticsRandomToJSON(json: any): AccountInfoValueStatisticsRandom {
    return AccountInfoValueStatisticsRandomToJSONTyped(json, false);
}

export function AccountInfoValueStatisticsRandomToJSONTyped(value?: AccountInfoValueStatisticsRandom | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
