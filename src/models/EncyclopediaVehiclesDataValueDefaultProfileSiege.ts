 ...
 * @export
 * @interface EncyclopediaVehiclesDataValueDefaultProfileSiege
 */
export interface EncyclopediaVehiclesDataValueDefaultProfileSiege {
    /**
     * Aiming time (s)
     * @type {number}
     * @memberof EncyclopediaVehiclesDataValueDefaultProfileSiege
     */
    aim_time: number;
    /**
...
/**
 * Check if a given object implements the EncyclopediaVehiclesDataValueDefaultProfileSiege interface.
 */
export function instanceOfEncyclopediaVehiclesDataValueDefaultProfileSiege(value: object): value is EncyclopediaVehiclesDataValueDefaultProfileSiege {
...
export function EncyclopediaVehiclesDataValueDefaultProfileSiegeFromJSON(json: any): EncyclopediaVehiclesDataValueDefaultProfileSiege {
    return EncyclopediaVehiclesDataValueDefaultProfileSiegeFromJSONTyped(json, false);
}

export function EncyclopediaVehiclesDataValueDefaultProfileSiegeFromJSONTyped(json: any, ignoreDiscriminator: boolean): EncyclopediaVehiclesDataValueDefaultProfileSiege {
    if (json == null) {
        return json;
    }
    return {
...
export function EncyclopediaVehiclesDataValueDefaultProfileSiegeToJSON(json: any): EncyclopediaVehiclesDataValueDefaultProfileSiege {
    return EncyclopediaVehiclesDataValueDefaultProfileSiegeToJSONTyped(json, false);
}

export function EncyclopediaVehiclesDataValueDefaultProfileSiegeToJSONTyped(value?: EncyclopediaVehiclesDataValueDefaultProfileSiege | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
...
export const EncyclopediaVehiclesDataValueDefaultProfileSiegePropertyValidationAttributesMap: {
    [property: string]: {
        maxLength?: number,
        minLength?: number,
        pattern?: string,
