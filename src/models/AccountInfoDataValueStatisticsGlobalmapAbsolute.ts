 ...
 * @export
 * @interface AccountInfoDataValueStatisticsGlobalmapAbsolute
 */
export interface AccountInfoDataValueStatisticsGlobalmapAbsolute {
    /**
     * Battles fought
     * @type {number}
     * @memberof AccountInfoDataValueStatisticsGlobalmapAbsolute
     */
    battles: number;
    /**
     * Victories
...
/**
 * Check if a given object implements the AccountInfoDataValueStatisticsGlobalmapAbsolute interface.
 */
export function instanceOfAccountInfoDataValueStatisticsGlobalmapAbsolute(value: object): value is AccountInfoDataValueStatisticsGlobalmapAbsolute {
...
export function AccountInfoDataValueStatisticsGlobalmapAbsoluteFromJSON(json: any): AccountInfoDataValueStatisticsGlobalmapAbsolute {
    return AccountInfoDataValueStatisticsGlobalmapAbsoluteFromJSONTyped(json, false);
}

export function AccountInfoDataValueStatisticsGlobalmapAbsoluteFromJSONTyped(json: any, ignoreDiscriminator: boolean): AccountInfoDataValueStatisticsGlobalmapAbsolute {
    if (json == null) {
        return json;
    }
    return {
...
export function AccountInfoDataValueStatisticsGlobalmapAbsoluteToJSON(json: any): AccountInfoDataValueStatisticsGlobalmapAbsolute {
    return AccountInfoDataValueStatisticsGlobalmapAbsoluteToJSONTyped(json, false);
}

export function AccountInfoDataValueStatisticsGlobalmapAbsoluteToJSONTyped(value?: AccountInfoDataValueStatisticsGlobalmapAbsolute | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
...
export const AccountInfoDataValueStatisticsGlobalmapAbsolutePropertyValidationAttributesMap: {
    [property: string]: {
        maxLength?: number,
        minLength?: number,
        pattern?: string,
