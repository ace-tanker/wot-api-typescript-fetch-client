 ...
 * @export
 * @interface TanksStatsValueItemGlobalmap
 */
export interface TanksStatsValueItemGlobalmap {
    /**
     * Battles fought
     * @type {number}
     * @memberof TanksStatsValueItemGlobalmap
     */
    battles: number;
    /**
     * Victories
...
/**
 * Check if a given object implements the TanksStatsValueItemGlobalmap interface.
 */
export function instanceOfTanksStatsValueItemGlobalmap(value: object): value is TanksStatsValueItemGlobalmap {
...
export function TanksStatsValueItemGlobalmapFromJSON(json: any): TanksStatsValueItemGlobalmap {
    return TanksStatsValueItemGlobalmapFromJSONTyped(json, false);
}

export function TanksStatsValueItemGlobalmapFromJSONTyped(json: any, ignoreDiscriminator: boolean): TanksStatsValueItemGlobalmap {
    if (json == null) {
        return json;
    }
    return {
...
export function TanksStatsValueItemGlobalmapToJSON(json: any): TanksStatsValueItemGlobalmap {
    return TanksStatsValueItemGlobalmapToJSONTyped(json, false);
}

export function TanksStatsValueItemGlobalmapToJSONTyped(value?: TanksStatsValueItemGlobalmap | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
