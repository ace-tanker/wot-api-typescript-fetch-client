 ...
 * @export
 * @interface AccountInfoValueStatisticsRankedSeason3
 */
export interface AccountInfoValueStatisticsRankedSeason3 {
    /**
     * Battles fought
     * @type {number}
     * @memberof AccountInfoValueStatisticsRankedSeason3
     */
    battles: number;
    /**
     * Victories
...
/**
 * Check if a given object implements the AccountInfoValueStatisticsRankedSeason3 interface.
 */
export function instanceOfAccountInfoValueStatisticsRankedSeason3(value: object): value is AccountInfoValueStatisticsRankedSeason3 {
...
export function AccountInfoValueStatisticsRankedSeason3FromJSON(json: any): AccountInfoValueStatisticsRankedSeason3 {
    return AccountInfoValueStatisticsRankedSeason3FromJSONTyped(json, false);
}

export function AccountInfoValueStatisticsRankedSeason3FromJSONTyped(json: any, ignoreDiscriminator: boolean): AccountInfoValueStatisticsRankedSeason3 {
    if (json == null) {
        return json;
    }
    return {
...
export function AccountInfoValueStatisticsRankedSeason3ToJSON(json: any): AccountInfoValueStatisticsRankedSeason3 {
    return AccountInfoValueStatisticsRankedSeason3ToJSONTyped(json, false);
}

export function AccountInfoValueStatisticsRankedSeason3ToJSONTyped(value?: AccountInfoValueStatisticsRankedSeason3 | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
