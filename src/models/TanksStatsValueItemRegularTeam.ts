 ...
 * @export
 * @interface TanksStatsValueItemRegularTeam
 */
export interface TanksStatsValueItemRegularTeam {
    /**
     * Battles fought
     * @type {number}
     * @memberof TanksStatsValueItemRegularTeam
     */
    battles: number;
    /**
     * Victories
...
/**
 * Check if a given object implements the TanksStatsValueItemRegularTeam interface.
 */
export function instanceOfTanksStatsValueItemRegularTeam(value: object): value is TanksStatsValueItemRegularTeam {
...
export function TanksStatsValueItemRegularTeamFromJSON(json: any): TanksStatsValueItemRegularTeam {
    return TanksStatsValueItemRegularTeamFromJSONTyped(json, false);
}

export function TanksStatsValueItemRegularTeamFromJSONTyped(json: any, ignoreDiscriminator: boolean): TanksStatsValueItemRegularTeam {
    if (json == null) {
        return json;
    }
    return {
...
export function TanksStatsValueItemRegularTeamToJSON(json: any): TanksStatsValueItemRegularTeam {
    return TanksStatsValueItemRegularTeamToJSONTyped(json, false);
}

export function TanksStatsValueItemRegularTeamToJSONTyped(value?: TanksStatsValueItemRegularTeam | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
