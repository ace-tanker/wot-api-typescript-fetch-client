 ...
 * @export
 * @interface AccountInfoDataValueStatisticsRegularTeam
 */
export interface AccountInfoDataValueStatisticsRegularTeam {
    /**
     * Battles fought
     * @type {number}
     * @memberof AccountInfoDataValueStatisticsRegularTeam
     */
    battles: number;
    /**
     * Victories
...
/**
 * Check if a given object implements the AccountInfoDataValueStatisticsRegularTeam interface.
 */
export function instanceOfAccountInfoDataValueStatisticsRegularTeam(value: object): value is AccountInfoDataValueStatisticsRegularTeam {
...
export function AccountInfoDataValueStatisticsRegularTeamFromJSON(json: any): AccountInfoDataValueStatisticsRegularTeam {
    return AccountInfoDataValueStatisticsRegularTeamFromJSONTyped(json, false);
}

export function AccountInfoDataValueStatisticsRegularTeamFromJSONTyped(json: any, ignoreDiscriminator: boolean): AccountInfoDataValueStatisticsRegularTeam {
    if (json == null) {
        return json;
    }
    return {
...
export function AccountInfoDataValueStatisticsRegularTeamToJSON(json: any): AccountInfoDataValueStatisticsRegularTeam {
    return AccountInfoDataValueStatisticsRegularTeamToJSONTyped(json, false);
}

export function AccountInfoDataValueStatisticsRegularTeamToJSONTyped(value?: AccountInfoDataValueStatisticsRegularTeam | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
...
export const AccountInfoDataValueStatisticsRegularTeamPropertyValidationAttributesMap: {
    [property: string]: {
        maxLength?: number,
        minLength?: number,
        pattern?: string,
