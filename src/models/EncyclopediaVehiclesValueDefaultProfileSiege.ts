 ...
 * @export
 * @interface EncyclopediaVehiclesValueDefaultProfileSiege
 */
export interface EncyclopediaVehiclesValueDefaultProfileSiege {
    /**
     * Aiming time (s)
     * @type {number}
     * @memberof EncyclopediaVehiclesValueDefaultProfileSiege
     */
    aimTime: number;
    /**
...
/**
 * Check if a given object implements the EncyclopediaVehiclesValueDefaultProfileSiege interface.
 */
export function instanceOfEncyclopediaVehiclesValueDefaultProfileSiege(value: object): value is EncyclopediaVehiclesValueDefaultProfileSiege {
...
export function EncyclopediaVehiclesValueDefaultProfileSiegeFromJSON(json: any): EncyclopediaVehiclesValueDefaultProfileSiege {
    return EncyclopediaVehiclesValueDefaultProfileSiegeFromJSONTyped(json, false);
}

export function EncyclopediaVehiclesValueDefaultProfileSiegeFromJSONTyped(json: any, ignoreDiscriminator: boolean): EncyclopediaVehiclesValueDefaultProfileSiege {
    if (json == null) {
        return json;
    }
    return {
...
export function EncyclopediaVehiclesValueDefaultProfileSiegeToJSON(json: any): EncyclopediaVehiclesValueDefaultProfileSiege {
    return EncyclopediaVehiclesValueDefaultProfileSiegeToJSONTyped(json, false);
}

export function EncyclopediaVehiclesValueDefaultProfileSiegeToJSONTyped(value?: EncyclopediaVehiclesValueDefaultProfileSiege | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
