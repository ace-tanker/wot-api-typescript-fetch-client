 ...
 * @export
 * @interface AccountInfoValueStatisticsRankedSeason2
 */
export interface AccountInfoValueStatisticsRankedSeason2 {
    /**
     * Battles fought
     * @type {number}
     * @memberof AccountInfoValueStatisticsRankedSeason2
     */
    battles: number;
    /**
     * Victories
...
/**
 * Check if a given object implements the AccountInfoValueStatisticsRankedSeason2 interface.
 */
export function instanceOfAccountInfoValueStatisticsRankedSeason2(value: object): value is AccountInfoValueStatisticsRankedSeason2 {
...
export function AccountInfoValueStatisticsRankedSeason2FromJSON(json: any): AccountInfoValueStatisticsRankedSeason2 {
    return AccountInfoValueStatisticsRankedSeason2FromJSONTyped(json, false);
}

export function AccountInfoValueStatisticsRankedSeason2FromJSONTyped(json: any, ignoreDiscriminator: boolean): AccountInfoValueStatisticsRankedSeason2 {
    if (json == null) {
        return json;
    }
    return {
...
export function AccountInfoValueStatisticsRankedSeason2ToJSON(json: any): AccountInfoValueStatisticsRankedSeason2 {
    return AccountInfoValueStatisticsRankedSeason2ToJSONTyped(json, false);
}

export function AccountInfoValueStatisticsRankedSeason2ToJSONTyped(value?: AccountInfoValueStatisticsRankedSeason2 | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
