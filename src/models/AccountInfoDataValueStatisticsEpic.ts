 ...
 * @export
 * @interface AccountInfoDataValueStatisticsEpic
 */
export interface AccountInfoDataValueStatisticsEpic {
    /**
     * Battles fought
     * @type {number}
     * @memberof AccountInfoDataValueStatisticsEpic
     */
    battles: number;
    /**
     * Victories
...
/**
 * Check if a given object implements the AccountInfoDataValueStatisticsEpic interface.
 */
export function instanceOfAccountInfoDataValueStatisticsEpic(value: object): value is AccountInfoDataValueStatisticsEpic {
...
export function AccountInfoDataValueStatisticsEpicFromJSON(json: any): AccountInfoDataValueStatisticsEpic {
    return AccountInfoDataValueStatisticsEpicFromJSONTyped(json, false);
}

export function AccountInfoDataValueStatisticsEpicFromJSONTyped(json: any, ignoreDiscriminator: boolean): AccountInfoDataValueStatisticsEpic {
    if (json == null) {
        return json;
    }
    return {
...
export function AccountInfoDataValueStatisticsEpicToJSON(json: any): AccountInfoDataValueStatisticsEpic {
    return AccountInfoDataValueStatisticsEpicToJSONTyped(json, false);
}

export function AccountInfoDataValueStatisticsEpicToJSONTyped(value?: AccountInfoDataValueStatisticsEpic | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
...
export const AccountInfoDataValueStatisticsEpicPropertyValidationAttributesMap: {
    [property: string]: {
        maxLength?: number,
        minLength?: number,
        pattern?: string,
