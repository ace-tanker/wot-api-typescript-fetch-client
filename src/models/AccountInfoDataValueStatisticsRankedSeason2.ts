 ...
 * @export
 * @interface AccountInfoDataValueStatisticsRankedSeason2
 */
export interface AccountInfoDataValueStatisticsRankedSeason2 {
    /**
     * Battles fought
     * @type {number}
     * @memberof AccountInfoDataValueStatisticsRankedSeason2
     */
    battles: number;
    /**
     * Victories
...
/**
 * Check if a given object implements the AccountInfoDataValueStatisticsRankedSeason2 interface.
 */
export function instanceOfAccountInfoDataValueStatisticsRankedSeason2(value: object): value is AccountInfoDataValueStatisticsRankedSeason2 {
...
export function AccountInfoDataValueStatisticsRankedSeason2FromJSON(json: any): AccountInfoDataValueStatisticsRankedSeason2 {
    return AccountInfoDataValueStatisticsRankedSeason2FromJSONTyped(json, false);
}

export function AccountInfoDataValueStatisticsRankedSeason2FromJSONTyped(json: any, ignoreDiscriminator: boolean): AccountInfoDataValueStatisticsRankedSeason2 {
    if (json == null) {
        return json;
    }
    return {
...
export function AccountInfoDataValueStatisticsRankedSeason2ToJSON(json: any): AccountInfoDataValueStatisticsRankedSeason2 {
    return AccountInfoDataValueStatisticsRankedSeason2ToJSONTyped(json, false);
}

export function AccountInfoDataValueStatisticsRankedSeason2ToJSONTyped(value?: AccountInfoDataValueStatisticsRankedSeason2 | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
...
export const AccountInfoDataValueStatisticsRankedSeason2PropertyValidationAttributesMap: {
    [property: string]: {
        maxLength?: number,
        minLength?: number,
        pattern?: string,
