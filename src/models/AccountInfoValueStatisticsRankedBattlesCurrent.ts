 ...
 * @export
 * @interface AccountInfoValueStatisticsRankedBattlesCurrent
 */
export interface AccountInfoValueStatisticsRankedBattlesCurrent {
    /**
     * Battles fought
     * @type {number}
     * @memberof AccountInfoValueStatisticsRankedBattlesCurrent
     */
    battles: number;
    /**
     * Victories
...
/**
 * Check if a given object implements the AccountInfoValueStatisticsRankedBattlesCurrent interface.
 */
export function instanceOfAccountInfoValueStatisticsRankedBattlesCurrent(value: object): value is AccountInfoValueStatisticsRankedBattlesCurrent {
...
export function AccountInfoValueStatisticsRankedBattlesCurrentFromJSON(json: any): AccountInfoValueStatisticsRankedBattlesCurrent {
    return AccountInfoValueStatisticsRankedBattlesCurrentFromJSONTyped(json, false);
}

export function AccountInfoValueStatisticsRankedBattlesCurrentFromJSONTyped(json: any, ignoreDiscriminator: boolean): AccountInfoValueStatisticsRankedBattlesCurrent {
    if (json == null) {
        return json;
    }
    return {
...
export function AccountInfoValueStatisticsRankedBattlesCurrentToJSON(json: any): AccountInfoValueStatisticsRankedBattlesCurrent {
    return AccountInfoValueStatisticsRankedBattlesCurrentToJSONTyped(json, false);
}

export function AccountInfoValueStatisticsRankedBattlesCurrentToJSONTyped(value?: AccountInfoValueStatisticsRankedBattlesCurrent | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
