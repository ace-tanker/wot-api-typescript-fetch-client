 ...
 * @export
 * @interface AccountInfoDataValueStatisticsStrongholdDefense
 */
export interface AccountInfoDataValueStatisticsStrongholdDefense {
    /**
     * Battles fought
     * @type {number}
     * @memberof AccountInfoDataValueStatisticsStrongholdDefense
     */
    battles: number;
    /**
     * Victories
...
/**
 * Check if a given object implements the AccountInfoDataValueStatisticsStrongholdDefense interface.
 */
export function instanceOfAccountInfoDataValueStatisticsStrongholdDefense(value: object): value is AccountInfoDataValueStatisticsStrongholdDefense {
...
export function AccountInfoDataValueStatisticsStrongholdDefenseFromJSON(json: any): AccountInfoDataValueStatisticsStrongholdDefense {
    return AccountInfoDataValueStatisticsStrongholdDefenseFromJSONTyped(json, false);
}

export function AccountInfoDataValueStatisticsStrongholdDefenseFromJSONTyped(json: any, ignoreDiscriminator: boolean): AccountInfoDataValueStatisticsStrongholdDefense {
    if (json == null) {
        return json;
    }
    return {
...
export function AccountInfoDataValueStatisticsStrongholdDefenseToJSON(json: any): AccountInfoDataValueStatisticsStrongholdDefense {
    return AccountInfoDataValueStatisticsStrongholdDefenseToJSONTyped(json, false);
}

export function AccountInfoDataValueStatisticsStrongholdDefenseToJSONTyped(value?: AccountInfoDataValueStatisticsStrongholdDefense | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
...
export const AccountInfoDataValueStatisticsStrongholdDefensePropertyValidationAttributesMap: {
    [property: string]: {
        maxLength?: number,
        minLength?: number,
        pattern?: string,
