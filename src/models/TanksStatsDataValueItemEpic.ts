 ...
 * @export
 * @interface TanksStatsDataValueItemEpic
 */
export interface TanksStatsDataValueItemEpic {
    /**
     * Battles fought
     * @type {number}
     * @memberof TanksStatsDataValueItemEpic
     */
    battles: number;
    /**
     * Victories
...
/**
 * Check if a given object implements the TanksStatsDataValueItemEpic interface.
 */
export function instanceOfTanksStatsDataValueItemEpic(value: object): value is TanksStatsDataValueItemEpic {
...
export function TanksStatsDataValueItemEpicFromJSON(json: any): TanksStatsDataValueItemEpic {
    return TanksStatsDataValueItemEpicFromJSONTyped(json, false);
}

export function TanksStatsDataValueItemEpicFromJSONTyped(json: any, ignoreDiscriminator: boolean): TanksStatsDataValueItemEpic {
    if (json == null) {
        return json;
    }
    return {
...
export function TanksStatsDataValueItemEpicToJSON(json: any): TanksStatsDataValueItemEpic {
    return TanksStatsDataValueItemEpicToJSONTyped(json, false);
}

export function TanksStatsDataValueItemEpicToJSONTyped(value?: TanksStatsDataValueItemEpic | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
...
export const TanksStatsDataValueItemEpicPropertyValidationAttributesMap: {
    [property: string]: {
        maxLength?: number,
        minLength?: number,
        pattern?: string,
