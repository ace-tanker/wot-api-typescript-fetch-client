 ...
 * @export
 * @interface AccountInfoDataValueStatisticsTeam
 */
export interface AccountInfoDataValueStatisticsTeam {
    /**
     * Battles fought
     * @type {number}
     * @memberof AccountInfoDataValueStatisticsTeam
     */
    battles: number;
    /**
     * Victories
...
/**
 * Check if a given object implements the AccountInfoDataValueStatisticsTeam interface.
 */
export function instanceOfAccountInfoDataValueStatisticsTeam(value: object): value is AccountInfoDataValueStatisticsTeam {
...
export function AccountInfoDataValueStatisticsTeamFromJSON(json: any): AccountInfoDataValueStatisticsTeam {
    return AccountInfoDataValueStatisticsTeamFromJSONTyped(json, false);
}

export function AccountInfoDataValueStatisticsTeamFromJSONTyped(json: any, ignoreDiscriminator: boolean): AccountInfoDataValueStatisticsTeam {
    if (json == null) {
        return json;
    }
    return {
...
export function AccountInfoDataValueStatisticsTeamToJSON(json: any): AccountInfoDataValueStatisticsTeam {
    return AccountInfoDataValueStatisticsTeamToJSONTyped(json, false);
}

export function AccountInfoDataValueStatisticsTeamToJSONTyped(value?: AccountInfoDataValueStatisticsTeam | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
...
export const AccountInfoDataValueStatisticsTeamPropertyValidationAttributesMap: {
    [property: string]: {
        maxLength?: number,
        minLength?: number,
        pattern?: string,
