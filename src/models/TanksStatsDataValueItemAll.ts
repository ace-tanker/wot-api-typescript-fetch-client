 ...
 * Overall Statistics
 * @export
 * @interface TanksStatsDataValueItemAll
 */
export interface TanksStatsDataValueItemAll {
    /**
     * Battles fought
     * @type {number}
     * @memberof TanksStatsDataValueItemAll
     */
    battles: number;
    /**
     * Victories
...
/**
 * Check if a given object implements the TanksStatsDataValueItemAll interface.
 */
export function instanceOfTanksStatsDataValueItemAll(value: object): value is TanksStatsDataValueItemAll {
...
export function TanksStatsDataValueItemAllFromJSON(json: any): TanksStatsDataValueItemAll {
    return TanksStatsDataValueItemAllFromJSONTyped(json, false);
}

export function TanksStatsDataValueItemAllFromJSONTyped(json: any, ignoreDiscriminator: boolean): TanksStatsDataValueItemAll {
    if (json == null) {
        return json;
    }
    return {
...
export function TanksStatsDataValueItemAllToJSON(json: any): TanksStatsDataValueItemAll {
    return TanksStatsDataValueItemAllToJSONTyped(json, false);
}

export function TanksStatsDataValueItemAllToJSONTyped(value?: TanksStatsDataValueItemAll | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
...
export const TanksStatsDataValueItemAllPropertyValidationAttributesMap: {
    [property: string]: {
        maxLength?: number,
        minLength?: number,
        pattern?: string,
