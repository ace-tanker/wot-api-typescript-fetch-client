 ...
 * @export
 * @interface AccountInfoDataValueStatisticsClan
 */
export interface AccountInfoDataValueStatisticsClan {
    /**
     * Battles fought
     * @type {number}
     * @memberof AccountInfoDataValueStatisticsClan
     */
    battles: number;
    /**
     * Victories
...
/**
 * Check if a given object implements the AccountInfoDataValueStatisticsClan interface.
 */
export function instanceOfAccountInfoDataValueStatisticsClan(value: object): value is AccountInfoDataValueStatisticsClan {
...
export function AccountInfoDataValueStatisticsClanFromJSON(json: any): AccountInfoDataValueStatisticsClan {
    return AccountInfoDataValueStatisticsClanFromJSONTyped(json, false);
}

export function AccountInfoDataValueStatisticsClanFromJSONTyped(json: any, ignoreDiscriminator: boolean): AccountInfoDataValueStatisticsClan {
    if (json == null) {
        return json;
    }
    return {
...
export function AccountInfoDataValueStatisticsClanToJSON(json: any): AccountInfoDataValueStatisticsClan {
    return AccountInfoDataValueStatisticsClanToJSONTyped(json, false);
}

export function AccountInfoDataValueStatisticsClanToJSONTyped(value?: AccountInfoDataValueStatisticsClan | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
...
export const AccountInfoDataValueStatisticsClanPropertyValidationAttributesMap: {
    [property: string]: {
        maxLength?: number,
        minLength?: number,
        pattern?: string,
