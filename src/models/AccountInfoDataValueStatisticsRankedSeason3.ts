 ...
 * @export
 * @interface AccountInfoDataValueStatisticsRankedSeason3
 */
export interface AccountInfoDataValueStatisticsRankedSeason3 {
    /**
     * Battles fought
     * @type {number}
     * @memberof AccountInfoDataValueStatisticsRankedSeason3
     */
    battles: number;
    /**
     * Victories
...
/**
 * Check if a given object implements the AccountInfoDataValueStatisticsRankedSeason3 interface.
 */
export function instanceOfAccountInfoDataValueStatisticsRankedSeason3(value: object): value is AccountInfoDataValueStatisticsRankedSeason3 {
...
export function AccountInfoDataValueStatisticsRankedSeason3FromJSON(json: any): AccountInfoDataValueStatisticsRankedSeason3 {
    return AccountInfoDataValueStatisticsRankedSeason3FromJSONTyped(json, false);
}

export function AccountInfoDataValueStatisticsRankedSeason3FromJSONTyped(json: any, ignoreDiscriminator: boolean): AccountInfoDataValueStatisticsRankedSeason3 {
    if (json == null) {
        return json;
    }
    return {
...
export function AccountInfoDataValueStatisticsRankedSeason3ToJSON(json: any): AccountInfoDataValueStatisticsRankedSeason3 {
    return AccountInfoDataValueStatisticsRankedSeason3ToJSONTyped(json, false);
}

export function AccountInfoDataValueStatisticsRankedSeason3ToJSONTyped(value?: AccountInfoDataValueStatisticsRankedSeason3 | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
...
export const AccountInfoDataValueStatisticsRankedSeason3PropertyValidationAttributesMap: {
    [property: string]: {
        maxLength?: number,
        minLength?: number,
        pattern?: string,
