 ...
 * @export
 * @interface AccountInfoDataValueStatisticsRanked10x10
 */
export interface AccountInfoDataValueStatisticsRanked10x10 {
    /**
     * Battles fought
     * @type {number}
     * @memberof AccountInfoDataValueStatisticsRanked10x10
     */
    battles: number;
    /**
     * Victories
...
/**
 * Check if a given object implements the AccountInfoDataValueStatisticsRanked10x10 interface.
 */
export function instanceOfAccountInfoDataValueStatisticsRanked10x10(value: object): value is AccountInfoDataValueStatisticsRanked10x10 {
...
export function AccountInfoDataValueStatisticsRanked10x10FromJSON(json: any): AccountInfoDataValueStatisticsRanked10x10 {
    return AccountInfoDataValueStatisticsRanked10x10FromJSONTyped(json, false);
}

export function AccountInfoDataValueStatisticsRanked10x10FromJSONTyped(json: any, ignoreDiscriminator: boolean): AccountInfoDataValueStatisticsRanked10x10 {
    if (json == null) {
        return json;
    }
    return {
...
export function AccountInfoDataValueStatisticsRanked10x10ToJSON(json: any): AccountInfoDataValueStatisticsRanked10x10 {
    return AccountInfoDataValueStatisticsRanked10x10ToJSONTyped(json, false);
}

export function AccountInfoDataValueStatisticsRanked10x10ToJSONTyped(value?: AccountInfoDataValueStatisticsRanked10x10 | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
...
export const AccountInfoDataValueStatisticsRanked10x10PropertyValidationAttributesMap: {
    [property: string]: {
        maxLength?: number,
        minLength?: number,
        pattern?: string,
