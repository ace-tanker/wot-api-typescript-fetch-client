 ...
 * @export
 * @interface AccountInfoDataValueStatisticsCompany
 */
export interface AccountInfoDataValueStatisticsCompany {
    /**
     * Battles fought
     * @type {number}
     * @memberof AccountInfoDataValueStatisticsCompany
     */
    battles: number;
    /**
     * Victories
...
/**
 * Check if a given object implements the AccountInfoDataValueStatisticsCompany interface.
 */
export function instanceOfAccountInfoDataValueStatisticsCompany(value: object): value is AccountInfoDataValueStatisticsCompany {
...
export function AccountInfoDataValueStatisticsCompanyFromJSON(json: any): AccountInfoDataValueStatisticsCompany {
    return AccountInfoDataValueStatisticsCompanyFromJSONTyped(json, false);
}

export function AccountInfoDataValueStatisticsCompanyFromJSONTyped(json: any, ignoreDiscriminator: boolean): AccountInfoDataValueStatisticsCompany {
    if (json == null) {
        return json;
    }
    return {
...
export function AccountInfoDataValueStatisticsCompanyToJSON(json: any): AccountInfoDataValueStatisticsCompany {
    return AccountInfoDataValueStatisticsCompanyToJSONTyped(json, false);
}

export function AccountInfoDataValueStatisticsCompanyToJSONTyped(value?: AccountInfoDataValueStatisticsCompany | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
...
export const AccountInfoDataValueStatisticsCompanyPropertyValidationAttributesMap: {
    [property: string]: {
        maxLength?: number,
        minLength?: number,
        pattern?: string,
