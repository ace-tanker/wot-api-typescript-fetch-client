 ...
 * @export
 */
export const EncyclopediaProvisionsErrorStatusEnum = {
    Error: 'error'
} as const;
export type EncyclopediaProvisionsErrorStatusEnum = typeof EncyclopediaProvisionsErrorStatusEnum[keyof typeof EncyclopediaProvisionsErrorStatusEnum];
