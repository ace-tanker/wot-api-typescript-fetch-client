 ...
 * @export
 * @interface AccountInfoValueStatisticsRankedSeason1
 */
export interface AccountInfoValueStatisticsRankedSeason1 {
    /**
     * Battles fought
     * @type {number}
     * @memberof AccountInfoValueStatisticsRankedSeason1
     */
    battles: number;
    /**
     * Victories
...
/**
 * Check if a given object implements the AccountInfoValueStatisticsRankedSeason1 interface.
 */
export function instanceOfAccountInfoValueStatisticsRankedSeason1(value: object): value is AccountInfoValueStatisticsRankedSeason1 {
...
export function AccountInfoValueStatisticsRankedSeason1FromJSON(json: any): AccountInfoValueStatisticsRankedSeason1 {
    return AccountInfoValueStatisticsRankedSeason1FromJSONTyped(json, false);
}

export function AccountInfoValueStatisticsRankedSeason1FromJSONTyped(json: any, ignoreDiscriminator: boolean): AccountInfoValueStatisticsRankedSeason1 {
    if (json == null) {
        return json;
    }
    return {
...
export function AccountInfoValueStatisticsRankedSeason1ToJSON(json: any): AccountInfoValueStatisticsRankedSeason1 {
    return AccountInfoValueStatisticsRankedSeason1ToJSONTyped(json, false);
}

export function AccountInfoValueStatisticsRankedSeason1ToJSONTyped(value?: AccountInfoValueStatisticsRankedSeason1 | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
