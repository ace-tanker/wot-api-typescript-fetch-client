 ...
 * @export
 * @interface AccountInfoValueStatisticsHistorical
 */
export interface AccountInfoValueStatisticsHistorical {
    /**
     * Battles fought
     * @type {number}
     * @memberof AccountInfoValueStatisticsHistorical
     */
    battles: number;
    /**
     * Victories
...
/**
 * Check if a given object implements the AccountInfoValueStatisticsHistorical interface.
 */
export function instanceOfAccountInfoValueStatisticsHistorical(value: object): value is AccountInfoValueStatisticsHistorical {
...
export function AccountInfoValueStatisticsHistoricalFromJSON(json: any): AccountInfoValueStatisticsHistorical {
    return AccountInfoValueStatisticsHistoricalFromJSONTyped(json, false);
}

export function AccountInfoValueStatisticsHistoricalFromJSONTyped(json: any, ignoreDiscriminator: boolean): AccountInfoValueStatisticsHistorical {
    if (json == null) {
        return json;
    }
    return {
...
export function AccountInfoValueStatisticsHistoricalToJSON(json: any): AccountInfoValueStatisticsHistorical {
    return AccountInfoValueStatisticsHistoricalToJSONTyped(json, false);
}

export function AccountInfoValueStatisticsHistoricalToJSONTyped(value?: AccountInfoValueStatisticsHistorical | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
