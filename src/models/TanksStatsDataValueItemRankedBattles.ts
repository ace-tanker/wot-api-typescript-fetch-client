 ...
 * @export
 * @interface TanksStatsDataValueItemRankedBattles
 */
export interface TanksStatsDataValueItemRankedBattles {
    /**
     * Battles fought
     * @type {number}
     * @memberof TanksStatsDataValueItemRankedBattles
     */
    battles: number;
    /**
     * Victories
...
/**
 * Check if a given object implements the TanksStatsDataValueItemRankedBattles interface.
 */
export function instanceOfTanksStatsDataValueItemRankedBattles(value: object): value is TanksStatsDataValueItemRankedBattles {
...
export function TanksStatsDataValueItemRankedBattlesFromJSON(json: any): TanksStatsDataValueItemRankedBattles {
    return TanksStatsDataValueItemRankedBattlesFromJSONTyped(json, false);
}

export function TanksStatsDataValueItemRankedBattlesFromJSONTyped(json: any, ignoreDiscriminator: boolean): TanksStatsDataValueItemRankedBattles {
    if (json == null) {
        return json;
    }
    return {
...
export function TanksStatsDataValueItemRankedBattlesToJSON(json: any): TanksStatsDataValueItemRankedBattles {
    return TanksStatsDataValueItemRankedBattlesToJSONTyped(json, false);
}

export function TanksStatsDataValueItemRankedBattlesToJSONTyped(value?: TanksStatsDataValueItemRankedBattles | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
...
export const TanksStatsDataValueItemRankedBattlesPropertyValidationAttributesMap: {
    [property: string]: {
        maxLength?: number,
        minLength?: number,
        pattern?: string,
