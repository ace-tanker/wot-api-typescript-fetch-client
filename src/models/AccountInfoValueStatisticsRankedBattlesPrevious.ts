 ...
 * @export
 * @interface AccountInfoValueStatisticsRankedBattlesPrevious
 */
export interface AccountInfoValueStatisticsRankedBattlesPrevious {
    /**
     * Battles fought
     * @type {number}
     * @memberof AccountInfoValueStatisticsRankedBattlesPrevious
     */
    battles: number;
    /**
     * Victories
...
/**
 * Check if a given object implements the AccountInfoValueStatisticsRankedBattlesPrevious interface.
 */
export function instanceOfAccountInfoValueStatisticsRankedBattlesPrevious(value: object): value is AccountInfoValueStatisticsRankedBattlesPrevious {
...
export function AccountInfoValueStatisticsRankedBattlesPreviousFromJSON(json: any): AccountInfoValueStatisticsRankedBattlesPrevious {
    return AccountInfoValueStatisticsRankedBattlesPreviousFromJSONTyped(json, false);
}

export function AccountInfoValueStatisticsRankedBattlesPreviousFromJSONTyped(json: any, ignoreDiscriminator: boolean): AccountInfoValueStatisticsRankedBattlesPrevious {
    if (json == null) {
        return json;
    }
    return {
...
export function AccountInfoValueStatisticsRankedBattlesPreviousToJSON(json: any): AccountInfoValueStatisticsRankedBattlesPrevious {
    return AccountInfoValueStatisticsRankedBattlesPreviousToJSONTyped(json, false);
}

export function AccountInfoValueStatisticsRankedBattlesPreviousToJSONTyped(value?: AccountInfoValueStatisticsRankedBattlesPrevious | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
