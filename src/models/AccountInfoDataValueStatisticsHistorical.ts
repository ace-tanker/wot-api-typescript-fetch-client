 ...
 * @export
 * @interface AccountInfoDataValueStatisticsHistorical
 */
export interface AccountInfoDataValueStatisticsHistorical {
    /**
     * Battles fought
     * @type {number}
     * @memberof AccountInfoDataValueStatisticsHistorical
     */
    battles: number;
    /**
     * Victories
...
/**
 * Check if a given object implements the AccountInfoDataValueStatisticsHistorical interface.
 */
export function instanceOfAccountInfoDataValueStatisticsHistorical(value: object): value is AccountInfoDataValueStatisticsHistorical {
...
export function AccountInfoDataValueStatisticsHistoricalFromJSON(json: any): AccountInfoDataValueStatisticsHistorical {
    return AccountInfoDataValueStatisticsHistoricalFromJSONTyped(json, false);
}

export function AccountInfoDataValueStatisticsHistoricalFromJSONTyped(json: any, ignoreDiscriminator: boolean): AccountInfoDataValueStatisticsHistorical {
    if (json == null) {
        return json;
    }
    return {
...
export function AccountInfoDataValueStatisticsHistoricalToJSON(json: any): AccountInfoDataValueStatisticsHistorical {
    return AccountInfoDataValueStatisticsHistoricalToJSONTyped(json, false);
}

export function AccountInfoDataValueStatisticsHistoricalToJSONTyped(value?: AccountInfoDataValueStatisticsHistorical | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
...
export const AccountInfoDataValueStatisticsHistoricalPropertyValidationAttributesMap: {
    [property: string]: {
        maxLength?: number,
        minLength?: number,
        pattern?: string,
