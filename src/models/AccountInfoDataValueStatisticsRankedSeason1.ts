 ...
 * @export
 * @interface AccountInfoDataValueStatisticsRankedSeason1
 */
export interface AccountInfoDataValueStatisticsRankedSeason1 {
    /**
     * Battles fought
     * @type {number}
     * @memberof AccountInfoDataValueStatisticsRankedSeason1
     */
    battles: number;
    /**
     * Victories
...
/**
 * Check if a given object implements the AccountInfoDataValueStatisticsRankedSeason1 interface.
 */
export function instanceOfAccountInfoDataValueStatisticsRankedSeason1(value: object): value is AccountInfoDataValueStatisticsRankedSeason1 {
...
export function AccountInfoDataValueStatisticsRankedSeason1FromJSON(json: any): AccountInfoDataValueStatisticsRankedSeason1 {
    return AccountInfoDataValueStatisticsRankedSeason1FromJSONTyped(json, false);
}

export function AccountInfoDataValueStatisticsRankedSeason1FromJSONTyped(json: any, ignoreDiscriminator: boolean): AccountInfoDataValueStatisticsRankedSeason1 {
    if (json == null) {
        return json;
    }
    return {
...
export function AccountInfoDataValueStatisticsRankedSeason1ToJSON(json: any): AccountInfoDataValueStatisticsRankedSeason1 {
    return AccountInfoDataValueStatisticsRankedSeason1ToJSONTyped(json, false);
}

export function AccountInfoDataValueStatisticsRankedSeason1ToJSONTyped(value?: AccountInfoDataValueStatisticsRankedSeason1 | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
...
export const AccountInfoDataValueStatisticsRankedSeason1PropertyValidationAttributesMap: {
    [property: string]: {
        maxLength?: number,
        minLength?: number,
        pattern?: string,
