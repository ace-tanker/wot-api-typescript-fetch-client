 ...
 * @export
 * @interface AccountInfoDataValueStatisticsRanked15x15
 */
export interface AccountInfoDataValueStatisticsRanked15x15 {
    /**
     * Battles fought
     * @type {number}
     * @memberof AccountInfoDataValueStatisticsRanked15x15
     */
    battles: number;
    /**
     * Victories
...
/**
 * Check if a given object implements the AccountInfoDataValueStatisticsRanked15x15 interface.
 */
export function instanceOfAccountInfoDataValueStatisticsRanked15x15(value: object): value is AccountInfoDataValueStatisticsRanked15x15 {
...
export function AccountInfoDataValueStatisticsRanked15x15FromJSON(json: any): AccountInfoDataValueStatisticsRanked15x15 {
    return AccountInfoDataValueStatisticsRanked15x15FromJSONTyped(json, false);
}

export function AccountInfoDataValueStatisticsRanked15x15FromJSONTyped(json: any, ignoreDiscriminator: boolean): AccountInfoDataValueStatisticsRanked15x15 {
    if (json == null) {
        return json;
    }
    return {
...
export function AccountInfoDataValueStatisticsRanked15x15ToJSON(json: any): AccountInfoDataValueStatisticsRanked15x15 {
    return AccountInfoDataValueStatisticsRanked15x15ToJSONTyped(json, false);
}

export function AccountInfoDataValueStatisticsRanked15x15ToJSONTyped(value?: AccountInfoDataValueStatisticsRanked15x15 | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
...
export const AccountInfoDataValueStatisticsRanked15x15PropertyValidationAttributesMap: {
    [property: string]: {
        maxLength?: number,
        minLength?: number,
        pattern?: string,
